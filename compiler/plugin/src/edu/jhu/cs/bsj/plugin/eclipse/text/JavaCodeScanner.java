...
/**
 * A Java code scanner.
 * This is taken from java-editor example.
 */
public class JavaCodeScanner extends RuleBasedScanner {
	 ...
	 *
	 * @param colorManager the color provider
	 */
	public JavaCodeScanner(ColorManager colorManager) {

		IToken keyword= new Token(new TextAttribute(colorManager.getColor(BSJHighlightColorProvider.KEYWORD)));
		IToken type= new Token(new TextAttribute(colorManager.getColor(BSJHighlightColorProvider.TYPE)));
		IToken string= new Token(new TextAttribute(colorManager.getColor(BSJHighlightColorProvider.STRING)));
		IToken comment= new Token(new TextAttribute(colorManager.getColor(BSJHighlightColorProvider.SINGLE_LINE_COMMENT)));
