...
public class BsjParserImpl implements BsjParser
{
			...
			DiagnosticListener<BsjSourceLocation> diagnosticListener) throws IOException
	{
		...
		return parse(name, new TokenRewriteStream(lexer), ParseRule.COMPILATION_UNIT, diagnosticListener);
	}
	...
	private <T extends Node> T parse(String name, TokenStream tokenStream, ParseRule<T> rule,
