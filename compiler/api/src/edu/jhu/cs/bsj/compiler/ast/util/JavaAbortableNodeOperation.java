...
public abstract class JavaAbortableNodeOperation<P,R,X extends Exception> implements BsjAbortableNodeOperation<P,R,X>
{
    /**
     ...
     */
    public abstract R handleBsjSpecificNode(BsjSpecificNode node, P p) throws X;
