 ...
 * anonymous classes) can make use of this class to reduce lines of code.
 *
...
public class BsjTypedNodeNoOpVisitor implements BsjTypedNodeVisitor
{
     ...
     *                     otherwise.
     */
    public void visitLocalVariableDeclarationNodeStart(LocalVariableDeclarationNode node, boolean mostSpecific)
    {
    }
    ...
    /**
     * Starts a visit for nodes of type SpliceNode.
     * @param node The node being visited.
     * @param mostSpecific <code>true</code> if this is the most specific call
     *                     which can be made for this node; <code>false</code>
     *                     otherwise.
     */
    public void visitSpliceNodeStart(SpliceNode node, boolean mostSpecific)
    {
    }
    ...
    /**
     * Stops a visit for nodes of type LocalVariableDeclarationNode.
     * @param node The node being visited.
     * @param mostSpecific <code>true</code> if this is the most specific call
     *                     which can be made for this node; <code>false</code>
     *                     otherwise.
     */
    public void visitLocalVariableDeclarationNodeStop(LocalVariableDeclarationNode node, boolean mostSpecific)
    {
    }
    ...
    /**
     * Stops a visit for nodes of type SpliceNode.
     * @param node The node being visited.
     * @param mostSpecific <code>true</code> if this is the most specific call
     *                     which can be made for this node; <code>false</code>
     *                     otherwise.
     */
    public void visitSpliceNodeStop(SpliceNode node, boolean mostSpecific)
    {
    }
