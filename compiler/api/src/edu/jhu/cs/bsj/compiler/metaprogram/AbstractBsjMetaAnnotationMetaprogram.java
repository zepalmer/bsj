 ...
 * for meta-annotation metaprograms.  It provides an inner class for the implementation of the returned metaprogram
 * that depends upon the abstract methods of this class for its functionality.  Specifically, execution of the
 * metaprogram can be defined in the {@link #execute(Context<MetaAnnotationMetaprogramAnchorNode>) execute} method.
...
public abstract class AbstractBsjMetaAnnotationMetaprogram implements BsjMetaAnnotationMetaprogram
{
	...
	{
		this(permanentTargets, permanentDependencies, MetaprogramLocalMode.INSERT, MetaprogramPackageMode.READ_ONLY);
	}
	 ...
	 */
	public AbstractBsjMetaAnnotationMetaprogram(List<String> permanentTargets, List<String> permanentDependencies,
			MetaprogramLocalMode localMode, MetaprogramPackageMode packageMode)
	{
	...
	/**
	 * This method can be used by subclasses to retrieve the package mode of this meta-annotation instance's metaprogram.
	...
	/**
	 * This method can be used by subclasses to retrieve the list of supplementary dependencies in which this meta-annotation
	 * instance's metaprogram participates.  This method is typically called by an annotation property getter of the
	 * subclass to wire that property to this functionality.
	...
	/**
	 * This method can be used by subclasses to indicate a list of supplementary dependencies in which this meta-annotation
	 * instance's metaprogram participates.  This method is typically called by an annotation property setter of the
	 * subclass to wire that property to this functionality.
