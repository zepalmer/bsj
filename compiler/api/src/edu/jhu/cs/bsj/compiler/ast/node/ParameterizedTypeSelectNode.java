 ...
 * <tt>ParameterizedTypeSelectNode</tt>.  The <tt>select</tt> child is a <tt>RawTypeNode</tt> containing the name
 * "B"; the <tt>base</tt> child is a {@link ParameterizedTypeNode}.  The <tt>base</tt> has children of a
