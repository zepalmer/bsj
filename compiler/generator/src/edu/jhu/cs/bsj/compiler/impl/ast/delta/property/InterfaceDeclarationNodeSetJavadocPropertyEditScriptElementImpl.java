...
public class InterfaceDeclarationNodeSetJavadocPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public InterfaceDeclarationNodeSetJavadocPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return InterfaceDeclarationNodeProperties.JAVADOC;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new InterfaceDeclarationNodeSetJavadocPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
