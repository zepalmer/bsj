...
public class AbstractlyUnmodifiedClassDeclarationNodeSetTypeParametersPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AbstractlyUnmodifiedClassDeclarationNodeSetTypeParametersPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    private <T extends ModifiersNode> void applyActual(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<TypeParameterListNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<TypeParameterListNode>((TypeParameterListNode)value);
        }
        target.setUnionForTypeParameters(union);
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]#" + getTargetId() + ".typeParameters := " + (getValueId() == null ? "null" : "#" + getValueId());
    }
    
    @Override
    public NodeProperty getProperty()
    {
        return AbstractlyUnmodifiedClassDeclarationNodeProperties.TYPE_PARAMETERS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AbstractlyUnmodifiedClassDeclarationNodeSetTypeParametersPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
