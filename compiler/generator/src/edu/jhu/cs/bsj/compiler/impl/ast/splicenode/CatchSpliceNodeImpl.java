...
import edu.jhu.cs.bsj.compiler.ast.node.CatchSpliceNode;
...
public class CatchSpliceNodeImpl extends SpliceNodeImpl implements CatchSpliceNode
{
    /** General constructor. */
    public CatchSpliceNodeImpl(
    ...
    {
        throw new SpliceNodeAccessException("Attempted to get property \"parameter\" from a splice node.");
    }
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setParameter(VariableNode arg)
    {
        throw new SpliceNodeAccessException("Attempted to set property \"parameter\" from a splice node.");
    }
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setBody(BlockStatementListNode arg)
    {
     ...
     */
    @Override
    public CatchSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeCatchSpliceNode(
