...
public class CreateDoWhileLoopNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateDoWhileLoopNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long condition,
            Long statement,
    ...
    public void apply(PatchState patchState)
    {
        ...
        DoWhileLoopNode createdNode = patchState.getNodeFactory().makeDoWhileLoopNodeWithUnions(condition,
                statement,
                metaAnnotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<DoWhileLoopNode> getCreateType()
    {
        return DoWhileLoopNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":DoWhileLoopNode(" + "condition=" + "#" + condition + "," + "statement=" + "#" + statement + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateDoWhileLoopNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
