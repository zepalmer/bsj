...
public class MetaprogramImportSpliceNodeImpl extends SpliceNodeImpl implements MetaprogramImportSpliceNode
{
    /** General constructor. */
    public MetaprogramImportSpliceNodeImpl(
    ...
    {
        throw new SpliceNodeAccessException("Attempted to get property \"importNode\" from a splice node.");
    }
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setImportNode(ImportNode arg)
    {
        throw new SpliceNodeAccessException("Attempted to set property \"importNode\" from a splice node.");
    }
    ...
    {
        return factory.makeMetaprogramImportSpliceNode(
