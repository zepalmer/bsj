...
public class CharLiteralNodeImpl extends NodeImpl implements CharLiteralNode
{
    ...
    private ReadWriteAttribute getAttribute(LocalAttribute attributeName)
    {
        ...
        if (attribute == null)
        {
            attribute = new ReadWriteAttribute(CharLiteralNodeImpl.this);
    ...
    {
        return operation.executeCharLiteralNode(this, p);
    }
    ...
    {
        return operation.executeCharLiteralNode(this, p1, p2);
    }
