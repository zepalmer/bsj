...
public class IfNodeSetConditionPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public IfNodeSetConditionPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return IfNodeProperties.CONDITION;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new IfNodeSetConditionPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
