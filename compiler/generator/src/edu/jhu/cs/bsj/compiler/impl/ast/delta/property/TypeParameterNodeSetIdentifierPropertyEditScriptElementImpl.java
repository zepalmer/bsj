...
public class TypeParameterNodeSetIdentifierPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public TypeParameterNodeSetIdentifierPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return TypeParameterNodeProperties.IDENTIFIER;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new TypeParameterNodeSetIdentifierPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
