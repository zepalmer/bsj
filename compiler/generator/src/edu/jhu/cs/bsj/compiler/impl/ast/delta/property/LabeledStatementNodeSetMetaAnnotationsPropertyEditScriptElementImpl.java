...
public class LabeledStatementNodeSetMetaAnnotationsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public LabeledStatementNodeSetMetaAnnotationsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return LabeledStatementNodeProperties.META_ANNOTATIONS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new LabeledStatementNodeSetMetaAnnotationsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
