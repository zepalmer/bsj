...
public class ConstructorBodyNodeSetStatementsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ConstructorBodyNodeSetStatementsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return ConstructorBodyNodeProperties.STATEMENTS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ConstructorBodyNodeSetStatementsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
