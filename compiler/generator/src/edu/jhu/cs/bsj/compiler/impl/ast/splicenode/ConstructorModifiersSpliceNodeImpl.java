...
import edu.jhu.cs.bsj.compiler.ast.node.ConstructorModifiersSpliceNode;
...
public class ConstructorModifiersSpliceNodeImpl extends SpliceNodeImpl implements ConstructorModifiersSpliceNode
{
    /** General constructor. */
    public ConstructorModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public ConstructorModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeConstructorModifiersSpliceNode(
