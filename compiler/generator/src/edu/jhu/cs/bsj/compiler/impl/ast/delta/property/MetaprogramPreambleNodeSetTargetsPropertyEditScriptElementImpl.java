...
public class MetaprogramPreambleNodeSetTargetsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MetaprogramPreambleNodeSetTargetsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<MetaprogramTargetListNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<MetaprogramTargetListNode>((MetaprogramTargetListNode)value);
        }
    ...
    {
        return MetaprogramPreambleNodeProperties.TARGETS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MetaprogramPreambleNodeSetTargetsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
