...
public class LabeledStatementNodeSetLabelPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public LabeledStatementNodeSetLabelPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return LabeledStatementNodeProperties.LABEL;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new LabeledStatementNodeSetLabelPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
