...
public class AbstractlyUnmodifiedClassDeclarationNodeSetExtendsClausePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AbstractlyUnmodifiedClassDeclarationNodeSetExtendsClausePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    private <T extends ModifiersNode> void applyActual(PatchState patchState)
    {
        ...
        target.setUnionForExtendsClause(union);
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]#" + getTargetId() + ".extendsClause := " + (getValueId() == null ? "null" : "#" + getValueId());
    }
    
    @Override
    public NodeProperty getProperty()
    {
        return AbstractlyUnmodifiedClassDeclarationNodeProperties.EXTENDS_CLAUSE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AbstractlyUnmodifiedClassDeclarationNodeSetExtendsClausePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
