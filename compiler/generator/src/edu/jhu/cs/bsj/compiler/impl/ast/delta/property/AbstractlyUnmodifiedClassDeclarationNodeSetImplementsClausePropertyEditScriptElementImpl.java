...
public class AbstractlyUnmodifiedClassDeclarationNodeSetImplementsClausePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AbstractlyUnmodifiedClassDeclarationNodeSetImplementsClausePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return AbstractlyUnmodifiedClassDeclarationNodeProperties.IMPLEMENTS_CLAUSE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AbstractlyUnmodifiedClassDeclarationNodeSetImplementsClausePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
