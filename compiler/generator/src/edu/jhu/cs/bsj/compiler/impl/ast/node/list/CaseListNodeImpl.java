...
public class CaseListNodeImpl extends ListNodeImpl<CaseNode> implements CaseListNode
{
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitCaseListNodeStart(this, true);
        ...
        visitor.visitCaseListNodeStop(this, true);
    ...
    {
        return operation.executeCaseListNode(this, p);
    }
    ...
    {
        return operation.executeCaseListNode(this, p1, p2);
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof CaseNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (CaseNode)after);
        }
        return false;
    }
