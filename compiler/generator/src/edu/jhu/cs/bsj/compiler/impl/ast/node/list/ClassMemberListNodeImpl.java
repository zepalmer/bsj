...
public class ClassMemberListNodeImpl extends ListNodeImpl<ClassMemberNode> implements ClassMemberListNode
{
    /** General constructor. */
    public ClassMemberListNodeImpl(
    ...
    /** Proxy constructor. */
    public ClassMemberListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, ClassMemberListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected ClassMemberListNode getBackingNode()
    {
        return (ClassMemberListNode)super.getBackingNode();
    }
    ...
    protected Class<ClassMemberNode> getChildrenElementType()
    {
        return ClassMemberNode.class;
    }
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitClassMemberListNodeStart(this, true);
        ...
        visitor.visitClassMemberListNodeStop(this, true);
    ...
    {
        return operation.executeClassMemberListNode(this, p);
    }
    ...
    {
        return operation.executeClassMemberListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends ClassMemberNode>> childrenCopy = new ArrayList<NodeUnion<? extends ClassMemberNode>>(getChildren().size());
        for (NodeUnion<? extends ClassMemberNode> element : getUnionForChildren())
        {
            NodeUnion<? extends ClassMemberNode> elementCopy;
        ...
        return factory.makeClassMemberListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof ClassMemberNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (ClassMemberNode)after);
        }
        return false;
    }
     ...
     */
    protected ClassMemberNode wrapElement(ClassMemberNode element)
    {
        return getProxyFactory().makeClassMemberNode(element);
    }
