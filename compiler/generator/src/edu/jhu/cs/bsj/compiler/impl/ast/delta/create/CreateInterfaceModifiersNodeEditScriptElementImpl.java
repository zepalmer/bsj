...
public class CreateInterfaceModifiersNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateInterfaceModifiersNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
    ...
    public void apply(PatchState patchState)
    {
        ...
        InterfaceModifiersNode createdNode = patchState.getNodeFactory().makeInterfaceModifiersNodeWithUnions(access,
                staticFlag,
                strictfpFlag,
                metaAnnotations,
                annotations,
    ...
    @Override
    public Class<InterfaceModifiersNode> getCreateType()
    {
        return InterfaceModifiersNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":InterfaceModifiersNode(" + "access=" + "{" + access + "}" + "," + "staticFlag=" + "{" + staticFlag + "}" + "," + "strictfpFlag=" + "{" + strictfpFlag + "}" + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "annotations=" + "#" + annotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateInterfaceModifiersNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
                this.access,
                this.staticFlag,
