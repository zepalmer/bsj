...
public class SuperFieldAccessNodeSetTypePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public SuperFieldAccessNodeSetTypePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return SuperFieldAccessNodeProperties.TYPE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new SuperFieldAccessNodeSetTypePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
