...
import edu.jhu.cs.bsj.compiler.ast.node.ClassModifiersSpliceNode;
...
public class ClassModifiersSpliceNodeImpl extends SpliceNodeImpl implements ClassModifiersSpliceNode
{
    /** General constructor. */
    public ClassModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public ClassModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeClassModifiersSpliceNode(
