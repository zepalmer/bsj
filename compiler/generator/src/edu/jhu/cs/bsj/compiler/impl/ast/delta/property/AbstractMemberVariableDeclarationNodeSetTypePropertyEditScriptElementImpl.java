...
public class AbstractMemberVariableDeclarationNodeSetTypePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AbstractMemberVariableDeclarationNodeSetTypePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return AbstractMemberVariableDeclarationNodeProperties.TYPE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AbstractMemberVariableDeclarationNodeSetTypePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
