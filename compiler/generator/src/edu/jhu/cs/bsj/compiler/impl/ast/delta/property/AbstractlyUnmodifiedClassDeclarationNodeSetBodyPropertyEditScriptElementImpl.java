...
public class AbstractlyUnmodifiedClassDeclarationNodeSetBodyPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AbstractlyUnmodifiedClassDeclarationNodeSetBodyPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    private <T extends ModifiersNode> void applyActual(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<ClassBodyNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<ClassBodyNode>((ClassBodyNode)value);
        }
    ...
    {
        return AbstractlyUnmodifiedClassDeclarationNodeProperties.BODY;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AbstractlyUnmodifiedClassDeclarationNodeSetBodyPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
