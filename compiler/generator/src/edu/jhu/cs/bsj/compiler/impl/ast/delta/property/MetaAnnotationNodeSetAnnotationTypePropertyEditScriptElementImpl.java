...
public class MetaAnnotationNodeSetAnnotationTypePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MetaAnnotationNodeSetAnnotationTypePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        MetaAnnotationNode target = (MetaAnnotationNode)patchState.getNode(this.getTargetId());
    ...
    {
        return MetaAnnotationNodeProperties.ANNOTATION_TYPE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MetaAnnotationNodeSetAnnotationTypePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
