...
public class AnnotationMemberMetaprogramAnchorNodeImpl extends ExplicitMetaprogramAnchorNodeImpl<AnnotationMemberNode> implements AnnotationMemberMetaprogramAnchorNode
{
    /** General constructor. */
    public AnnotationMemberMetaprogramAnchorNodeImpl(
    ...
    /** Proxy constructor. */
    public AnnotationMemberMetaprogramAnchorNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, AnnotationMemberMetaprogramAnchorNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected AnnotationMemberMetaprogramAnchorNode getBackingNode()
    {
        return (AnnotationMemberMetaprogramAnchorNode)super.getBackingNode();
    }
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitAnnotationMemberMetaprogramAnchorNodeStart(this, true);
        ...
        visitor.visitAnnotationMemberMetaprogramAnchorNodeStop(this, true);
    ...
    {
        return operation.executeAnnotationMemberMetaprogramAnchorNode(this, p);
    }
    ...
    {
        return operation.executeAnnotationMemberMetaprogramAnchorNode(this, p1, p2);
    }
    ...
    public AnnotationMemberMetaprogramAnchorNode deepCopy(BsjNodeFactory factory)
    {
        ...
        return factory.makeAnnotationMemberMetaprogramAnchorNodeWithUnions(
                metaprogramCopy,
                getStartLocation(),
                getStopLocation());
    }
