...
public class MetaAnnotationElementListNodeImpl extends ListNodeImpl<MetaAnnotationElementNode> implements MetaAnnotationElementListNode
{
    /** General constructor. */
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitMetaAnnotationElementListNodeStart(this, true);
        ...
        visitor.visitMetaAnnotationElementListNodeStop(this, true);
    ...
    {
        return operation.executeMetaAnnotationElementListNode(this, p);
    }
    ...
    {
        return operation.executeMetaAnnotationElementListNode(this, p1, p2);
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof MetaAnnotationElementNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (MetaAnnotationElementNode)after);
        }
        return false;
    }
