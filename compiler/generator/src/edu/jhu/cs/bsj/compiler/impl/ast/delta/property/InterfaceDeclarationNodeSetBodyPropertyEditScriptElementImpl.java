...
public class InterfaceDeclarationNodeSetBodyPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public InterfaceDeclarationNodeSetBodyPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<InterfaceBodyNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<InterfaceBodyNode>((InterfaceBodyNode)value);
        }
    ...
    {
        return InterfaceDeclarationNodeProperties.BODY;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new InterfaceDeclarationNodeSetBodyPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
