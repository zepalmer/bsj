...
public class MetaprogramPreambleNodeSetImportsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MetaprogramPreambleNodeSetImportsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return MetaprogramPreambleNodeProperties.IMPORTS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MetaprogramPreambleNodeSetImportsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
