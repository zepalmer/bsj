...
public class EnumConstantDeclarationNodeSetModifiersPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public EnumConstantDeclarationNodeSetModifiersPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<EnumConstantModifiersNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<EnumConstantModifiersNode>((EnumConstantModifiersNode)value);
        }
    ...
    {
        return EnumConstantDeclarationNodeProperties.MODIFIERS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new EnumConstantDeclarationNodeSetModifiersPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
