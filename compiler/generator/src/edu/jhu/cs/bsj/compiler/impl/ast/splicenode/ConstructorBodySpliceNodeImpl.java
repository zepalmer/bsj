...
import edu.jhu.cs.bsj.compiler.ast.node.ConstructorBodySpliceNode;
...
public class ConstructorBodySpliceNodeImpl extends SpliceNodeImpl implements ConstructorBodySpliceNode
{
    /** General constructor. */
    public ConstructorBodySpliceNodeImpl(
    ...
    {
        throw new SpliceNodeAccessException("Attempted to get property \"constructorInvocation\" from a splice node.");
    }
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setConstructorInvocation(ConstructorInvocationNode arg)
    {
        throw new SpliceNodeAccessException("Attempted to set property \"constructorInvocation\" from a splice node.");
    }
    ...
    {
        return factory.makeConstructorBodySpliceNode(
