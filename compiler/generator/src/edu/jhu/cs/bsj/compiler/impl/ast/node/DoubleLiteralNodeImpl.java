...
import edu.jhu.cs.bsj.compiler.impl.ast.delta.property.DoubleLiteralNodeSetValuePropertyEditScriptElementImpl;
import edu.jhu.cs.bsj.compiler.impl.ast.properties.DoubleLiteralNodeProperties;

@Generated(value={"edu.jhu.cs.bsj.compiler.utils.generator.SourceGenerator"})
public class DoubleLiteralNodeImpl extends NodeImpl implements DoubleLiteralNode
{
     ...
     */
    private Set<DoubleLiteralNodeProperties> populatedProperties;
    ...
    /** Proxy constructor. */
    public DoubleLiteralNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, DoubleLiteralNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
        this.populatedProperties = EnumSet.noneOf(DoubleLiteralNodeProperties.class);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected DoubleLiteralNode getBackingNode()
    {
        return (DoubleLiteralNode)super.getBackingNode();
    }
    ...
    private void checkValueWrapped()
    {
        if (this.populatedProperties == null || this.populatedProperties.contains(
                DoubleLiteralNodeProperties.VALUE))
            return;
        this.populatedProperties.add(DoubleLiteralNodeProperties.VALUE);
    ...
    public void setValue(Double value)
    {
        ...
        if (this.getManager().isRecordingEdits())
            super.recordEdit(new DoubleLiteralNodeSetValuePropertyEditScriptElementImpl(this.getManager().getCurrentMetaprogramId(), this.getUid(), value));
    }
    
    private void doSetValue(Double value)
    {
        this.value = value;
    }
    ...
    {
        return operation.executeDoubleLiteralNode(this, p1, p2);
    }
