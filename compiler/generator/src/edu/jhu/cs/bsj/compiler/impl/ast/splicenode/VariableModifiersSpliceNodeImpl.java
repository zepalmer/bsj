...
import edu.jhu.cs.bsj.compiler.ast.node.VariableModifiersSpliceNode;
...
public class VariableModifiersSpliceNodeImpl extends SpliceNodeImpl implements VariableModifiersSpliceNode
{
    /** General constructor. */
    public VariableModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public VariableModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeVariableModifiersSpliceNode(
