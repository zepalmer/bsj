...
public class ConstantDeclarationNodeImpl extends AbstractMemberVariableDeclarationNodeImpl<ConstantModifiersNode> implements ConstantDeclarationNode
{
    ...
    {
        return operation.executeConstantDeclarationNode(this, p1, p2);
    }
    ...
    {
        NodeUnion<? extends ConstantModifiersNode> modifiersCopy;
        switch (getUnionForModifiers().getType())
        {
            case NORMAL:
                if (getUnionForModifiers().getNormalNode() == null)
                {
                    modifiersCopy = factory.<ConstantModifiersNode>makeNormalNodeUnion(null);
                } else
                {
            ...
            case SPLICE:
                ...
                {
                    modifiersCopy = factory.<ConstantModifiersNode>makeSpliceNodeUnion(null);
                } else
                {
        ...
        return factory.makeConstantDeclarationNodeWithUnions(
                modifiersCopy,
                typeCopy,
                declaratorsCopy,
                javadocCopy,
