...
public class CaseNodeSetStatementsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public CaseNodeSetStatementsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        CaseNode target = (CaseNode)patchState.getNode(this.getTargetId());
    ...
    {
        return CaseNodeProperties.STATEMENTS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new CaseNodeSetStatementsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
