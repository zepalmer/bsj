...
public class WhileLoopNodeSetConditionPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public WhileLoopNodeSetConditionPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return WhileLoopNodeProperties.CONDITION;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new WhileLoopNodeSetConditionPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
