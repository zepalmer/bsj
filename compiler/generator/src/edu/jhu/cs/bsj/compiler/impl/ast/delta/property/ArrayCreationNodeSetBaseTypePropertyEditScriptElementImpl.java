...
public class ArrayCreationNodeSetBaseTypePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ArrayCreationNodeSetBaseTypePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<BaseTypeNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<BaseTypeNode>((BaseTypeNode)value);
        }
    ...
    {
        return ArrayCreationNodeProperties.BASE_TYPE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ArrayCreationNodeSetBaseTypePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
