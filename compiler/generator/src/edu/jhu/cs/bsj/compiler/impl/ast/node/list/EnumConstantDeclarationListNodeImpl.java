...
public class EnumConstantDeclarationListNodeImpl extends ListNodeImpl<EnumConstantDeclarationNode> implements EnumConstantDeclarationListNode
{
    ...
    /** Proxy constructor. */
    public EnumConstantDeclarationListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, EnumConstantDeclarationListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected EnumConstantDeclarationListNode getBackingNode()
    {
        return (EnumConstantDeclarationListNode)super.getBackingNode();
    }
    ...
    protected Class<EnumConstantDeclarationNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitEnumConstantDeclarationListNodeStart(this, true);
        ...
        visitor.visitEnumConstantDeclarationListNodeStop(this, true);
    ...
    {
        return operation.executeEnumConstantDeclarationListNode(this, p);
    }
    ...
    {
        return operation.executeEnumConstantDeclarationListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends EnumConstantDeclarationNode>> childrenCopy = new ArrayList<NodeUnion<? extends EnumConstantDeclarationNode>>(getChildren().size());
        for (NodeUnion<? extends EnumConstantDeclarationNode> element : getUnionForChildren())
        {
            NodeUnion<? extends EnumConstantDeclarationNode> elementCopy;
        ...
        return factory.makeEnumConstantDeclarationListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof EnumConstantDeclarationNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (EnumConstantDeclarationNode)after);
        }
        return false;
    }
     ...
     */
    protected EnumConstantDeclarationNode wrapElement(EnumConstantDeclarationNode element)
    {
        return getProxyFactory().makeEnumConstantDeclarationNode(element);
    }
