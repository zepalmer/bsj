...
public class AnnotationMemberListNodeImpl extends ListNodeImpl<AnnotationMemberNode> implements AnnotationMemberListNode
{
    /** General constructor. */
    public AnnotationMemberListNodeImpl(
    ...
    /** Proxy constructor. */
    public AnnotationMemberListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, AnnotationMemberListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected AnnotationMemberListNode getBackingNode()
    {
        return (AnnotationMemberListNode)super.getBackingNode();
    }
    ...
    protected Class<AnnotationMemberNode> getChildrenElementType()
    {
        return AnnotationMemberNode.class;
    }
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitAnnotationMemberListNodeStart(this, true);
        ...
        visitor.visitAnnotationMemberListNodeStop(this, true);
    ...
    {
        return operation.executeAnnotationMemberListNode(this, p);
    }
    ...
    {
        return operation.executeAnnotationMemberListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends AnnotationMemberNode>> childrenCopy = new ArrayList<NodeUnion<? extends AnnotationMemberNode>>(getChildren().size());
        for (NodeUnion<? extends AnnotationMemberNode> element : getUnionForChildren())
        {
            NodeUnion<? extends AnnotationMemberNode> elementCopy;
        ...
        return factory.makeAnnotationMemberListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof AnnotationMemberNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (AnnotationMemberNode)after);
        }
        return false;
    }
     ...
     */
    protected AnnotationMemberNode wrapElement(AnnotationMemberNode element)
    {
        return getProxyFactory().makeAnnotationMemberNode(element);
    }
