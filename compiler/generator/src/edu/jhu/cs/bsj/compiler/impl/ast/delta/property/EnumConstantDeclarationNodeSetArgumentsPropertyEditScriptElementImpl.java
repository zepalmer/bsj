...
public class EnumConstantDeclarationNodeSetArgumentsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public EnumConstantDeclarationNodeSetArgumentsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return EnumConstantDeclarationNodeProperties.ARGUMENTS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new EnumConstantDeclarationNodeSetArgumentsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
