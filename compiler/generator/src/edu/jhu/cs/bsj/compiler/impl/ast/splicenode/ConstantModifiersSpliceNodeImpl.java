...
import edu.jhu.cs.bsj.compiler.ast.node.ConstantModifiersSpliceNode;
...
public class ConstantModifiersSpliceNodeImpl extends SpliceNodeImpl implements ConstantModifiersSpliceNode
{
    /** General constructor. */
    public ConstantModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public ConstantModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeConstantModifiersSpliceNode(
