...
public class MetaprogramTargetListNodeImpl extends ListNodeImpl<MetaprogramTargetNode> implements MetaprogramTargetListNode
{
    /** General constructor. */
    public MetaprogramTargetListNodeImpl(
    ...
    /** Proxy constructor. */
    public MetaprogramTargetListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, MetaprogramTargetListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected MetaprogramTargetListNode getBackingNode()
    {
        return (MetaprogramTargetListNode)super.getBackingNode();
    }
    ...
    protected Class<MetaprogramTargetNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitMetaprogramTargetListNodeStart(this, true);
        ...
        visitor.visitMetaprogramTargetListNodeStop(this, true);
    ...
    {
        return operation.executeMetaprogramTargetListNode(this, p);
    }
    ...
    {
        return operation.executeMetaprogramTargetListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends MetaprogramTargetNode>> childrenCopy = new ArrayList<NodeUnion<? extends MetaprogramTargetNode>>(getChildren().size());
        for (NodeUnion<? extends MetaprogramTargetNode> element : getUnionForChildren())
        {
            NodeUnion<? extends MetaprogramTargetNode> elementCopy;
        ...
        return factory.makeMetaprogramTargetListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof MetaprogramTargetNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (MetaprogramTargetNode)after);
        }
        return false;
    }
     ...
     */
    protected MetaprogramTargetNode wrapElement(MetaprogramTargetNode element)
    {
        return getProxyFactory().makeMetaprogramTargetNode(element);
    }
