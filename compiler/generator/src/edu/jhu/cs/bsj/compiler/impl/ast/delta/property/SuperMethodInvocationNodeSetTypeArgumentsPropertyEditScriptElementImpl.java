...
public class SuperMethodInvocationNodeSetTypeArgumentsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public SuperMethodInvocationNodeSetTypeArgumentsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return SuperMethodInvocationNodeProperties.TYPE_ARGUMENTS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new SuperMethodInvocationNodeSetTypeArgumentsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
