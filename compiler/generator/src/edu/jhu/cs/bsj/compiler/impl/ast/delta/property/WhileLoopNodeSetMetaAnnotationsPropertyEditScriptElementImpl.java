...
public class WhileLoopNodeSetMetaAnnotationsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public WhileLoopNodeSetMetaAnnotationsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        WhileLoopNode target = (WhileLoopNode)patchState.getNode(this.getTargetId());
    ...
    {
        return WhileLoopNodeProperties.META_ANNOTATIONS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new WhileLoopNodeSetMetaAnnotationsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
