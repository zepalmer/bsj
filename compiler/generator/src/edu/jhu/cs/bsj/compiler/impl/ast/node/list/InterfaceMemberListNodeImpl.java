...
public class InterfaceMemberListNodeImpl extends ListNodeImpl<InterfaceMemberNode> implements InterfaceMemberListNode
{
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitInterfaceMemberListNodeStart(this, true);
        ...
        visitor.visitInterfaceMemberListNodeStop(this, true);
    ...
    {
        return operation.executeInterfaceMemberListNode(this, p);
    }
    ...
    {
        return operation.executeInterfaceMemberListNode(this, p1, p2);
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof InterfaceMemberNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (InterfaceMemberNode)after);
        }
        return false;
    }
