...
public class IfNodeSetMetaAnnotationsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public IfNodeSetMetaAnnotationsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return IfNodeProperties.META_ANNOTATIONS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new IfNodeSetMetaAnnotationsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
