...
{
    /** General constructor. */
    public TypeDeclarationListNodeImpl(
    ...
    protected Class<TypeDeclarationNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitTypeDeclarationListNodeStart(this, true);
        ...
        visitor.visitTypeDeclarationListNodeStop(this, true);
    ...
    {
        return operation.executeTypeDeclarationListNode(this, p);
    }
    ...
    {
        return operation.executeTypeDeclarationListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends TypeDeclarationNode>> childrenCopy = new ArrayList<NodeUnion<? extends TypeDeclarationNode>>(getChildren().size());
        for (NodeUnion<? extends TypeDeclarationNode> element : getUnionForChildren())
        {
            NodeUnion<? extends TypeDeclarationNode> elementCopy;
        ...
        return factory.makeTypeDeclarationListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof TypeDeclarationNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (TypeDeclarationNode)after);
        }
        return false;
    }
