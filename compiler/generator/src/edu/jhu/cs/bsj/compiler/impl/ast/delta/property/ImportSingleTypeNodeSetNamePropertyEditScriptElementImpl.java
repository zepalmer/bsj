...
public class ImportSingleTypeNodeSetNamePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ImportSingleTypeNodeSetNamePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        ImportSingleTypeNode target = (ImportSingleTypeNode)patchState.getNode(this.getTargetId());
    ...
    {
        return ImportSingleTypeNodeProperties.NAME;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ImportSingleTypeNodeSetNamePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
