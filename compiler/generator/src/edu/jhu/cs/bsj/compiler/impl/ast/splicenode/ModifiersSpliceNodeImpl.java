...
import edu.jhu.cs.bsj.compiler.ast.node.ModifiersSpliceNode;
...
public class ModifiersSpliceNodeImpl extends SpliceNodeImpl implements ModifiersSpliceNode
{
    /** General constructor. */
    public ModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public ModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeModifiersSpliceNode(
