...
public class PackageDeclarationNodeSetNamePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public PackageDeclarationNodeSetNamePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return PackageDeclarationNodeProperties.NAME;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new PackageDeclarationNodeSetNamePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
