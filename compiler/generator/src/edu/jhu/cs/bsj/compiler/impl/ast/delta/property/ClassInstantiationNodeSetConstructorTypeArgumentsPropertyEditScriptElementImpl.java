...
public class ClassInstantiationNodeSetConstructorTypeArgumentsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ClassInstantiationNodeSetConstructorTypeArgumentsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return "constructorTypeArguments";
    }
    ...
    public void apply(PatchState patchState)
    {
        ...
        target.setUnionForConstructorTypeArguments(union);
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]#" + getTargetId() + ".constructorTypeArguments := " + (getValueId() == null ? "null" : "#" + getValueId());
    }
    
    @Override
    public NodeProperty getProperty()
    {
        return ClassInstantiationNodeProperties.CONSTRUCTOR_TYPE_ARGUMENTS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ClassInstantiationNodeSetConstructorTypeArgumentsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
