...
public class SingleStaticImportNodeSetNamePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public SingleStaticImportNodeSetNamePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return SingleStaticImportNodeProperties.NAME;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new SingleStaticImportNodeSetNamePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
