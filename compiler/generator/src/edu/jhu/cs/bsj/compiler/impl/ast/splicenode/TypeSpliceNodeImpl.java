...
import edu.jhu.cs.bsj.compiler.ast.node.TypeSpliceNode;
import edu.jhu.cs.bsj.compiler.impl.ast.BsjNodeManager;
import edu.jhu.cs.bsj.compiler.impl.ast.node.meta.SpliceNodeImpl;

@Generated(value={"edu.jhu.cs.bsj.compiler.utils.generator.SourceGenerator"})
public class TypeSpliceNodeImpl extends SpliceNodeImpl implements TypeSpliceNode
{
    /** General constructor. */
    public TypeSpliceNodeImpl(
     ...
     */
    @Override
    public TypeSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeTypeSpliceNode(
