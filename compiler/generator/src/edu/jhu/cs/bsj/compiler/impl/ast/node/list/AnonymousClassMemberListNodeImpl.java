...
{
    /** General constructor. */
    public AnonymousClassMemberListNodeImpl(
    ...
    protected Class<AnonymousClassMemberNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitAnonymousClassMemberListNodeStart(this, true);
        ...
        visitor.visitAnonymousClassMemberListNodeStop(this, true);
    ...
    {
        return operation.executeAnonymousClassMemberListNode(this, p);
    }
    ...
    {
        return operation.executeAnonymousClassMemberListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends AnonymousClassMemberNode>> childrenCopy = new ArrayList<NodeUnion<? extends AnonymousClassMemberNode>>(getChildren().size());
        for (NodeUnion<? extends AnonymousClassMemberNode> element : getUnionForChildren())
        {
            NodeUnion<? extends AnonymousClassMemberNode> elementCopy;
        ...
        return factory.makeAnonymousClassMemberListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof AnonymousClassMemberNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (AnonymousClassMemberNode)after);
        }
        return false;
    }
