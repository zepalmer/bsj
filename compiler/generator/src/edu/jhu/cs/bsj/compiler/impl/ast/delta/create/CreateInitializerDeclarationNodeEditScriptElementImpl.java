...
public class CreateInitializerDeclarationNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateInitializerDeclarationNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
    ...
    {
        final boolean staticInitializer = this.staticInitializer;
        ...
        InitializerDeclarationNode createdNode = patchState.getNodeFactory().makeInitializerDeclarationNodeWithUnions(staticInitializer,
                body,
                metaAnnotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<InitializerDeclarationNode> getCreateType()
    {
        return InitializerDeclarationNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":InitializerDeclarationNode(" + "staticInitializer=" + "{" + staticInitializer + "}" + "," + "body=" + "#" + body + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateInitializerDeclarationNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
