...
public class ConstructorDeclarationNodeSetJavadocPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ConstructorDeclarationNodeSetJavadocPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return ConstructorDeclarationNodeProperties.JAVADOC;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ConstructorDeclarationNodeSetJavadocPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
