...
public class ClassBodyNodeSetMembersPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ClassBodyNodeSetMembersPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        ClassBodyNode target = (ClassBodyNode)patchState.getNode(this.getTargetId());
    ...
    {
        return ClassBodyNodeProperties.MEMBERS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ClassBodyNodeSetMembersPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
