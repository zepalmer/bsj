...
public class CreateThrowNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateThrowNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long expression,
    ...
    public void apply(PatchState patchState)
    {
        ...
        ThrowNode createdNode = patchState.getNodeFactory().makeThrowNodeWithUnions(expression,
                metaAnnotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<ThrowNode> getCreateType()
    {
    ...
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":ThrowNode(" + "expression=" + "#" + expression + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateThrowNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
