...
public class AssignmentNodeSetVariablePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AssignmentNodeSetVariablePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return AssignmentNodeProperties.VARIABLE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AssignmentNodeSetVariablePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
