...
public class CreatePackageDeclarationNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreatePackageDeclarationNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long name,
    ...
    public void apply(PatchState patchState)
    {
        ...
        PackageDeclarationNode createdNode = patchState.getNodeFactory().makePackageDeclarationNodeWithUnions(name,
                metaAnnotations,
                annotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<PackageDeclarationNode> getCreateType()
    {
    ...
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":PackageDeclarationNode(" + "name=" + "#" + name + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "annotations=" + "#" + annotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreatePackageDeclarationNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
