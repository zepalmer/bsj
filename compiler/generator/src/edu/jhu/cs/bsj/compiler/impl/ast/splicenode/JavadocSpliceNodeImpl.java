...
import edu.jhu.cs.bsj.compiler.ast.node.JavadocSpliceNode;
import edu.jhu.cs.bsj.compiler.impl.ast.BsjNodeManager;
import edu.jhu.cs.bsj.compiler.impl.ast.node.meta.SpliceNodeImpl;

@Generated(value={"edu.jhu.cs.bsj.compiler.utils.generator.SourceGenerator"})
public class JavadocSpliceNodeImpl extends SpliceNodeImpl implements JavadocSpliceNode
{
    /** General constructor. */
    public JavadocSpliceNodeImpl(
    ...
    {
        throw new SpliceNodeAccessException("Attempted to get property \"text\" from a splice node.");
    }
    ...
    {
        throw new SpliceNodeAccessException("Attempted to set property \"text\" from a splice node.");
    }
    ...
    {
        return factory.makeJavadocSpliceNode(
