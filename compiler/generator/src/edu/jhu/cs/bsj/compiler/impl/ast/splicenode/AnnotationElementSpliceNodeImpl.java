...
import edu.jhu.cs.bsj.compiler.ast.node.AnnotationElementSpliceNode;
...
public class AnnotationElementSpliceNodeImpl extends SpliceNodeImpl implements AnnotationElementSpliceNode
{
    /** General constructor. */
    public AnnotationElementSpliceNodeImpl(
    ...
    {
        throw new SpliceNodeAccessException("Attempted to get property \"value\" from a splice node.");
    }
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setValue(AnnotationValueNode arg)
    {
        throw new SpliceNodeAccessException("Attempted to set property \"value\" from a splice node.");
    }
     ...
     */
    @Override
    public AnnotationElementSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeAnnotationElementSpliceNode(
