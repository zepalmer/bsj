...
public class TryNodeSetMetaAnnotationsPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public TryNodeSetMetaAnnotationsPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return TryNodeProperties.META_ANNOTATIONS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new TryNodeSetMetaAnnotationsPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
