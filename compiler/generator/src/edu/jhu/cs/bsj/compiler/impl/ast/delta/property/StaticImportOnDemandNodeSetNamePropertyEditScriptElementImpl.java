...
public class StaticImportOnDemandNodeSetNamePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public StaticImportOnDemandNodeSetNamePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        StaticImportOnDemandNode target = (StaticImportOnDemandNode)patchState.getNode(this.getTargetId());
    ...
    {
        return StaticImportOnDemandNodeProperties.NAME;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new StaticImportOnDemandNodeSetNamePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
