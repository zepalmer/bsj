...
public class CreateNoOperationNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    private final Long metaAnnotations;
    private final BsjSourceLocation startLocation;
    private final BsjSourceLocation stopLocation;
    
    public CreateNoOperationNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
    ...
    public void apply(PatchState patchState)
    {
        ...
        NoOperationNode createdNode = patchState.getNodeFactory().makeNoOperationNodeWithUnions(metaAnnotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<NoOperationNode> getCreateType()
    {
        return NoOperationNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":NoOperationNode(" + "metaAnnotations=" + "#" + metaAnnotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateNoOperationNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
