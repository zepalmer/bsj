...
import edu.jhu.cs.bsj.compiler.ast.node.ClassBodySpliceNode;
...
public class ClassBodySpliceNodeImpl extends SpliceNodeImpl implements ClassBodySpliceNode
{
    /** General constructor. */
    public ClassBodySpliceNodeImpl(
     ...
     */
    @Override
    public ClassBodySpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeClassBodySpliceNode(
