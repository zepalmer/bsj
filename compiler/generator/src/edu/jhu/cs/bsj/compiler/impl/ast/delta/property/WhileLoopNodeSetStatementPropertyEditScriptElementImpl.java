...
public class WhileLoopNodeSetStatementPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public WhileLoopNodeSetStatementPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return WhileLoopNodeProperties.STATEMENT;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new WhileLoopNodeSetStatementPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
