...
public class BlockStatementMetaprogramAnchorNodeImpl extends ExplicitMetaprogramAnchorNodeImpl<BlockStatementNode> implements BlockStatementMetaprogramAnchorNode
{
    ...
    /** Proxy constructor. */
    public BlockStatementMetaprogramAnchorNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, BlockStatementMetaprogramAnchorNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected BlockStatementMetaprogramAnchorNode getBackingNode()
    {
        return (BlockStatementMetaprogramAnchorNode)super.getBackingNode();
    }
     ...
     */
    public Class<BlockStatementNode> getReplacementType()
    {
    ...
    {
        return operation.executeBlockStatementMetaprogramAnchorNode(this, p1, p2);
    }
    ...
    public BlockStatementMetaprogramAnchorNode deepCopy(BsjNodeFactory factory)
    {
        ...
        return factory.makeBlockStatementMetaprogramAnchorNodeWithUnions(
                metaprogramCopy,
                getStartLocation(),
                getStopLocation());
    }
