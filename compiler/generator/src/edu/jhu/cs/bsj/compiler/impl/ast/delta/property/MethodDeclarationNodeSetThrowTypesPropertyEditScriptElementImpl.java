...
public class MethodDeclarationNodeSetThrowTypesPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MethodDeclarationNodeSetThrowTypesPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return MethodDeclarationNodeProperties.THROW_TYPES;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MethodDeclarationNodeSetThrowTypesPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
