...
public class MetaprogramImportListNodeImpl extends ListNodeImpl<MetaprogramImportNode> implements MetaprogramImportListNode
{
    /** General constructor. */
    public MetaprogramImportListNodeImpl(
    ...
    /** Proxy constructor. */
    public MetaprogramImportListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, MetaprogramImportListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected MetaprogramImportListNode getBackingNode()
    {
        return (MetaprogramImportListNode)super.getBackingNode();
    }
    ...
    protected Class<MetaprogramImportNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitMetaprogramImportListNodeStart(this, true);
        ...
        visitor.visitMetaprogramImportListNodeStop(this, true);
    ...
    {
        return operation.executeMetaprogramImportListNode(this, p);
    }
    ...
    {
        return operation.executeMetaprogramImportListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends MetaprogramImportNode>> childrenCopy = new ArrayList<NodeUnion<? extends MetaprogramImportNode>>(getChildren().size());
        for (NodeUnion<? extends MetaprogramImportNode> element : getUnionForChildren())
        {
            NodeUnion<? extends MetaprogramImportNode> elementCopy;
        ...
        return factory.makeMetaprogramImportListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof MetaprogramImportNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (MetaprogramImportNode)after);
        }
        return false;
    }
     ...
     */
    protected MetaprogramImportNode wrapElement(MetaprogramImportNode element)
    {
        return getProxyFactory().makeMetaprogramImportNode(element);
    }
