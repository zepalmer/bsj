...
public class MetaprogramDependencyListNodeImpl extends ListNodeImpl<MetaprogramDependencyNode> implements MetaprogramDependencyListNode
{
    ...
    {
        List<MetaprogramDependencyNode> childrenCopy = new ArrayList<MetaprogramDependencyNode>(getChildren().size());
        for (MetaprogramDependencyNode element : getChildren())
        {
            childrenCopy.add(element.deepCopy(factory));
        }
        
        return factory.makeMetaprogramDependencyListNode(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
