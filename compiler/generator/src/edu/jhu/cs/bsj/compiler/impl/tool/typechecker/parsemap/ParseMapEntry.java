...
import edu.jhu.cs.bsj.compiler.impl.tool.typechecker.parsemap.rule.ParseRuleExecutor;
...
public class ParseMapEntry
{
	...
	private Set<? extends ParseRuleExecutor> rules;
	/** The in-context type for this parse map entry. */
	private BsjExplicitlyDeclaredType inContextType;
	
	public ParseMapEntry(Set<? extends ParseRuleExecutor> rules, BsjExplicitlyDeclaredType inContextType)
	{
		super();
		this.rules = rules;
	...
	public Set<? extends ParseRuleExecutor> getRules()
	{
		return rules;
	}
