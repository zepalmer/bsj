...
public class CreateInstanceOfNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateInstanceOfNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long expression,
            Long type,
    ...
    public void apply(PatchState patchState)
    {
        ...
        InstanceOfNode createdNode = patchState.getNodeFactory().makeInstanceOfNodeWithUnions(expression,
                type,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<InstanceOfNode> getCreateType()
    {
        return InstanceOfNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":InstanceOfNode(" + "expression=" + "#" + expression + "," + "type=" + "#" + type + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateInstanceOfNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
