...
public class SingleElementAnnotationNodeSetValuePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public SingleElementAnnotationNodeSetValuePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        SingleElementAnnotationNode target = (SingleElementAnnotationNode)patchState.getNode(this.getTargetId());
    ...
    {
        return SingleElementAnnotationNodeProperties.VALUE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new SingleElementAnnotationNodeSetValuePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
