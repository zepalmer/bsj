...
import edu.jhu.cs.bsj.compiler.ast.node.AnonymousClassBodySpliceNode;
...
public class AnonymousClassBodySpliceNodeImpl extends SpliceNodeImpl implements AnonymousClassBodySpliceNode
{
    /** General constructor. */
    public AnonymousClassBodySpliceNodeImpl(
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setMembers(AnonymousClassMemberListNode arg)
    {
     ...
     */
    @Override
    public AnonymousClassBodySpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeAnonymousClassBodySpliceNode(
