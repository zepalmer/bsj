...
public class MetaAnnotationElementNodeSetValuePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MetaAnnotationElementNodeSetValuePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return MetaAnnotationElementNodeProperties.VALUE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MetaAnnotationElementNodeSetValuePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
