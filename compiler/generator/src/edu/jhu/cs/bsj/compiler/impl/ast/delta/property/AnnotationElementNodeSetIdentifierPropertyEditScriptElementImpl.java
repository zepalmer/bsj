...
public class AnnotationElementNodeSetIdentifierPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AnnotationElementNodeSetIdentifierPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        AnnotationElementNode target = (AnnotationElementNode)patchState.getNode(this.getTargetId());
    ...
    {
        return AnnotationElementNodeProperties.IDENTIFIER;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AnnotationElementNodeSetIdentifierPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
