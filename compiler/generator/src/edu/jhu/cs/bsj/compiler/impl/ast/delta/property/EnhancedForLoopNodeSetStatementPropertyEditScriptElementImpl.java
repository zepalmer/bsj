...
public class EnhancedForLoopNodeSetStatementPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public EnhancedForLoopNodeSetStatementPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return EnhancedForLoopNodeProperties.STATEMENT;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new EnhancedForLoopNodeSetStatementPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
