...
public class MethodDeclarationNodeSetParametersPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MethodDeclarationNodeSetParametersPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return MethodDeclarationNodeProperties.PARAMETERS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MethodDeclarationNodeSetParametersPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
