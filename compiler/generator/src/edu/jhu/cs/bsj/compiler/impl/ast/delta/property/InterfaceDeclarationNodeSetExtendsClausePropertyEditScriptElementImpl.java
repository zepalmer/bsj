...
public class InterfaceDeclarationNodeSetExtendsClausePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public InterfaceDeclarationNodeSetExtendsClausePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return InterfaceDeclarationNodeProperties.EXTENDS_CLAUSE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new InterfaceDeclarationNodeSetExtendsClausePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
