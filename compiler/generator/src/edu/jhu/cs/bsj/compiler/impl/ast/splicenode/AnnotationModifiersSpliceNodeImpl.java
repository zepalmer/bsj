...
import edu.jhu.cs.bsj.compiler.ast.node.AnnotationModifiersSpliceNode;
...
public class AnnotationModifiersSpliceNodeImpl extends SpliceNodeImpl implements AnnotationModifiersSpliceNode
{
    /** General constructor. */
    public AnnotationModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public AnnotationModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeAnnotationModifiersSpliceNode(
