...
public class ClassLiteralNodeSetValuePropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ClassLiteralNodeSetValuePropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        ClassLiteralNode target = (ClassLiteralNode)patchState.getNode(this.getTargetId());
        final NodeUnion<? extends LiteralizableTypeNode> union;
        if (value instanceof SpliceNode)
        {
            union = new SpliceNodeUnion<LiteralizableTypeNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<LiteralizableTypeNode>((LiteralizableTypeNode)value);
        }
    ...
    {
        return ClassLiteralNodeProperties.VALUE;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ClassLiteralNodeSetValuePropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
