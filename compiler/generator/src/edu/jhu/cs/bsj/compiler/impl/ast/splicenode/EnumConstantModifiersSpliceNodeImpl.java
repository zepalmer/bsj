...
import edu.jhu.cs.bsj.compiler.ast.node.EnumConstantModifiersSpliceNode;
...
public class EnumConstantModifiersSpliceNodeImpl extends SpliceNodeImpl implements EnumConstantModifiersSpliceNode
{
    /** General constructor. */
    public EnumConstantModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public EnumConstantModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeEnumConstantModifiersSpliceNode(
