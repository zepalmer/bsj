...
import edu.jhu.cs.bsj.compiler.ast.node.ImportSpliceNode;
import edu.jhu.cs.bsj.compiler.ast.node.NameNode;
import edu.jhu.cs.bsj.compiler.impl.ast.BsjNodeManager;
import edu.jhu.cs.bsj.compiler.impl.ast.node.meta.SpliceNodeImpl;

@Generated(value={"edu.jhu.cs.bsj.compiler.utils.generator.SourceGenerator"})
public class ImportSpliceNodeImpl extends SpliceNodeImpl implements ImportSpliceNode
{
    /** General constructor. */
    public ImportSpliceNodeImpl(
     ...
     */
    @Override
    public ImportSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeImportSpliceNode(
