...
public class CreateVariableAccessNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateVariableAccessNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long expression,
            Long identifier,
    ...
    public void apply(PatchState patchState)
    {
        ...
        VariableAccessNode createdNode = patchState.getNodeFactory().makeVariableAccessNodeWithUnions(expression,
                identifier,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<VariableAccessNode> getCreateType()
    {
        return VariableAccessNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":VariableAccessNode(" + "expression=" + "#" + expression + "," + "identifier=" + "#" + identifier + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateVariableAccessNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
