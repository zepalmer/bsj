...
public class ConstructorModifiersNodeImpl extends ModifiersNodeImpl implements ConstructorModifiersNode
{
    ...
    private ReadWriteAttribute getAttribute(LocalAttribute attributeName)
    {
        ...
        if (attribute == null)
        {
            attribute = new ReadWriteAttribute(ConstructorModifiersNodeImpl.this);
    ...
    {
        return operation.executeConstructorModifiersNode(this, p1, p2);
    }
    ...
    public ConstructorModifiersNode deepCopy(BsjNodeFactory factory)
    {
        ...
        return factory.makeConstructorModifiersNodeWithUnions(
                getAccess(),
                metaAnnotationsCopy,
                annotationsCopy,
                getStartLocation(),
