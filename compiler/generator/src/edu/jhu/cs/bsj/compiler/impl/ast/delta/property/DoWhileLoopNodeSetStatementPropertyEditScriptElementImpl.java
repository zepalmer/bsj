...
public class DoWhileLoopNodeSetStatementPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public DoWhileLoopNodeSetStatementPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return DoWhileLoopNodeProperties.STATEMENT;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new DoWhileLoopNodeSetStatementPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
