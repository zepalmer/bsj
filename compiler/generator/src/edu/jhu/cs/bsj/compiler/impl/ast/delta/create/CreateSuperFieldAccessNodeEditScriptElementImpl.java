...
public class CreateSuperFieldAccessNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateSuperFieldAccessNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long type,
            Long identifier,
    ...
    public void apply(PatchState patchState)
    {
        ...
        SuperFieldAccessNode createdNode = patchState.getNodeFactory().makeSuperFieldAccessNodeWithUnions(type,
                identifier,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<SuperFieldAccessNode> getCreateType()
    {
        return SuperFieldAccessNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":SuperFieldAccessNode(" + "type=" + "#" + type + "," + "identifier=" + "#" + identifier + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateSuperFieldAccessNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
