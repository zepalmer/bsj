...
public class VariableDeclaratorListNodeImpl extends ListNodeImpl<VariableDeclaratorNode> implements VariableDeclaratorListNode
{
    ...
    /** Proxy constructor. */
    public VariableDeclaratorListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, VariableDeclaratorListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected VariableDeclaratorListNode getBackingNode()
    {
        return (VariableDeclaratorListNode)super.getBackingNode();
    }
    ...
    protected Class<VariableDeclaratorNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitVariableDeclaratorListNodeStart(this, true);
        ...
        visitor.visitVariableDeclaratorListNodeStop(this, true);
    ...
    {
        return operation.executeVariableDeclaratorListNode(this, p);
    }
    ...
    {
        return operation.executeVariableDeclaratorListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends VariableDeclaratorNode>> childrenCopy = new ArrayList<NodeUnion<? extends VariableDeclaratorNode>>(getChildren().size());
        for (NodeUnion<? extends VariableDeclaratorNode> element : getUnionForChildren())
        {
            NodeUnion<? extends VariableDeclaratorNode> elementCopy;
        ...
        return factory.makeVariableDeclaratorListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof VariableDeclaratorNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (VariableDeclaratorNode)after);
        }
        return false;
    }
     ...
     */
    public Class<VariableDeclaratorNode> getElementType()
    {
        return VariableDeclaratorNode.class;
    }
     ...
     */
    protected VariableDeclaratorNode wrapElement(VariableDeclaratorNode element)
    {
        return getProxyFactory().makeVariableDeclaratorNode(element);
    }
