...
import edu.jhu.cs.bsj.compiler.ast.node.EnumModifiersSpliceNode;
...
public class EnumModifiersSpliceNodeImpl extends SpliceNodeImpl implements EnumModifiersSpliceNode
{
    /** General constructor. */
    public EnumModifiersSpliceNodeImpl(
     ...
     */
    @Override
    public EnumModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeEnumModifiersSpliceNode(
