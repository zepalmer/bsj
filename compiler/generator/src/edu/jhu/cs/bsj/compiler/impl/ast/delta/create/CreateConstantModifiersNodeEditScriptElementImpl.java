...
public class CreateConstantModifiersNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateConstantModifiersNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
    ...
    public void apply(PatchState patchState)
    {
        ...
        ConstantModifiersNode createdNode = patchState.getNodeFactory().makeConstantModifiersNodeWithUnions(metaAnnotations,
                annotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<ConstantModifiersNode> getCreateType()
    {
        return ConstantModifiersNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":ConstantModifiersNode(" + "metaAnnotations=" + "#" + metaAnnotations + "," + "annotations=" + "#" + annotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateConstantModifiersNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
