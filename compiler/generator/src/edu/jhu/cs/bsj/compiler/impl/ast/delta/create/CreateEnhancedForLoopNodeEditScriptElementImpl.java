...
public class CreateEnhancedForLoopNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateEnhancedForLoopNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long variable,
            Long expression,
    ...
    public void apply(PatchState patchState)
    {
        final VariableNode variableNode = 
                (VariableNode)patchState.getNode(this.variable);
        final NodeUnion<? extends VariableNode> variable;
        {
            final NodeUnion<? extends VariableNode> union;
            if (variableNode instanceof SpliceNode)
            {
                union = new SpliceNodeUnion<VariableNode>((SpliceNode)variableNode);
            } else 
            {
                union = new NormalNodeUnion<VariableNode>((VariableNode)variableNode);
            }
            variable = union;
        }
        ...
        EnhancedForLoopNode createdNode = patchState.getNodeFactory().makeEnhancedForLoopNodeWithUnions(variable,
                expression,
                statement,
                metaAnnotations,
                startLocation,
    ...
    @Override
    public Class<EnhancedForLoopNode> getCreateType()
    {
        return EnhancedForLoopNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":EnhancedForLoopNode(" + "variable=" + "#" + variable + "," + "expression=" + "#" + expression + "," + "statement=" + "#" + statement + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateEnhancedForLoopNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
