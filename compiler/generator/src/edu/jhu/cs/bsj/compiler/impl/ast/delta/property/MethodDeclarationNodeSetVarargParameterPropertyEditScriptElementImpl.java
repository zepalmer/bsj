...
public class MethodDeclarationNodeSetVarargParameterPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MethodDeclarationNodeSetVarargParameterPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return MethodDeclarationNodeProperties.VARARG_PARAMETER;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MethodDeclarationNodeSetVarargParameterPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
