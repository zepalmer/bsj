...
public class MetaprogramNodeSetBodyPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public MetaprogramNodeSetBodyPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return MetaprogramNodeProperties.BODY;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new MetaprogramNodeSetBodyPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
