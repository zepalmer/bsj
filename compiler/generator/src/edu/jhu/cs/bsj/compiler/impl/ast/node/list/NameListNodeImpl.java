...
public class NameListNodeImpl extends ListNodeImpl<NameNode> implements NameListNode
{
    /** General constructor. */
    public NameListNodeImpl(
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitNameListNodeStart(this, true);
        ...
        visitor.visitNameListNodeStop(this, true);
    ...
    {
        return operation.executeNameListNode(this, p);
    }
    ...
    {
        List<NameNode> childrenCopy = new ArrayList<NameNode>(getChildren().size());
        for (NameNode element : getChildren())
        {
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof NameNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (NameNode)after);
        }
        return false;
    }
