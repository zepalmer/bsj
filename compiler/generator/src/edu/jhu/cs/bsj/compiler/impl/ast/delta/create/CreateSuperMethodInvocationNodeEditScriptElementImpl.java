...
public class CreateSuperMethodInvocationNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateSuperMethodInvocationNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long type,
            Long identifier,
    ...
    public void apply(PatchState patchState)
    {
        ...
        SuperMethodInvocationNode createdNode = patchState.getNodeFactory().makeSuperMethodInvocationNodeWithUnions(type,
                identifier,
                arguments,
                typeArguments,
                startLocation,
    ...
    @Override
    public Class<SuperMethodInvocationNode> getCreateType()
    {
        return SuperMethodInvocationNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":SuperMethodInvocationNode(" + "type=" + "#" + type + "," + "identifier=" + "#" + identifier + "," + "arguments=" + "#" + arguments + "," + "typeArguments=" + "#" + typeArguments + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateSuperMethodInvocationNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
