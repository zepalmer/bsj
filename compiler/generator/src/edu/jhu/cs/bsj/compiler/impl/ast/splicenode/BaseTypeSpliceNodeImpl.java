...
import edu.jhu.cs.bsj.compiler.ast.node.BaseTypeSpliceNode;
import edu.jhu.cs.bsj.compiler.ast.node.ExpressionNode;
import edu.jhu.cs.bsj.compiler.impl.ast.BsjNodeManager;
import edu.jhu.cs.bsj.compiler.impl.ast.node.meta.SpliceNodeImpl;

@Generated(value={"edu.jhu.cs.bsj.compiler.utils.generator.SourceGenerator"})
public class BaseTypeSpliceNodeImpl extends SpliceNodeImpl implements BaseTypeSpliceNode
{
    /** General constructor. */
    public BaseTypeSpliceNodeImpl(
     ...
     */
    @Override
    public BaseTypeSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeBaseTypeSpliceNode(
