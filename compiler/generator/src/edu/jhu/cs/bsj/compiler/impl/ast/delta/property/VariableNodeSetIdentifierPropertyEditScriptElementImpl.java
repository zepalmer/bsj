...
public class VariableNodeSetIdentifierPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public VariableNodeSetIdentifierPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        VariableNode target = (VariableNode)patchState.getNode(this.getTargetId());
    ...
    {
        return VariableNodeProperties.IDENTIFIER;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new VariableNodeSetIdentifierPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
