...
public class CreateEnumConstantModifiersNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateEnumConstantModifiersNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
    ...
    public void apply(PatchState patchState)
    {
        ...
        EnumConstantModifiersNode createdNode = patchState.getNodeFactory().makeEnumConstantModifiersNodeWithUnions(metaAnnotations,
                annotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<EnumConstantModifiersNode> getCreateType()
    {
        return EnumConstantModifiersNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":EnumConstantModifiersNode(" + "metaAnnotations=" + "#" + metaAnnotations + "," + "annotations=" + "#" + annotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateEnumConstantModifiersNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
