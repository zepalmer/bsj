...
public class CatchListNodeImpl extends ListNodeImpl<CatchNode> implements CatchListNode
{
    /** General constructor. */
    public CatchListNodeImpl(
    ...
    /** Proxy constructor. */
    public CatchListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, CatchListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected CatchListNode getBackingNode()
    {
        return (CatchListNode)super.getBackingNode();
    }
    ...
    protected Class<CatchNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitCatchListNodeStart(this, true);
    ...
    {
        return operation.executeCatchListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends CatchNode>> childrenCopy = new ArrayList<NodeUnion<? extends CatchNode>>(getChildren().size());
        for (NodeUnion<? extends CatchNode> element : getUnionForChildren())
        {
            NodeUnion<? extends CatchNode> elementCopy;
        ...
        return factory.makeCatchListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof CatchNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (CatchNode)after);
        }
        return false;
    }
     ...
     */
    public Class<CatchNode> getElementType()
    {
        return CatchNode.class;
    }
     ...
     */
    protected CatchNode wrapElement(CatchNode element)
    {
        return getProxyFactory().makeCatchNode(element);
    }
