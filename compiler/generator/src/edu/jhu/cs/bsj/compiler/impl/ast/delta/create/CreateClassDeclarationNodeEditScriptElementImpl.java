...
public class CreateClassDeclarationNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateClassDeclarationNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long modifiers,
            Long extendsClause,
    ...
    {
        final ClassModifiersNode modifiersNode = 
                (ClassModifiersNode)patchState.getNode(this.modifiers);
        final NodeUnion<? extends ClassModifiersNode> modifiers;
        {
            final NodeUnion<? extends ClassModifiersNode> union;
            if (modifiersNode instanceof SpliceNode)
            {
                union = new SpliceNodeUnion<ClassModifiersNode>((SpliceNode)modifiersNode);
            } else 
            {
                union = new NormalNodeUnion<ClassModifiersNode>((ClassModifiersNode)modifiersNode);
            }
            modifiers = union;
        }
        ...
        ClassDeclarationNode createdNode = patchState.getNodeFactory().makeClassDeclarationNodeWithUnions(modifiers,
                extendsClause,
                implementsClause,
                body,
                typeParameters,
    ...
    @Override
    public Class<ClassDeclarationNode> getCreateType()
    {
    ...
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":ClassDeclarationNode(" + "modifiers=" + "#" + modifiers + "," + "extendsClause=" + "#" + extendsClause + "," + "implementsClause=" + "#" + implementsClause + "," + "body=" + "#" + body + "," + "typeParameters=" + "#" + typeParameters + "," + "identifier=" + "#" + identifier + "," + "javadoc=" + "#" + javadoc + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateClassDeclarationNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
