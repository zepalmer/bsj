...
public class AnnotationValueListNodeImpl extends ListNodeImpl<AnnotationValueNode> implements AnnotationValueListNode
{
    /** General constructor. */
    ...
    /** Proxy constructor. */
    public AnnotationValueListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, AnnotationValueListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected AnnotationValueListNode getBackingNode()
    {
        return (AnnotationValueListNode)super.getBackingNode();
    }
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitAnnotationValueListNodeStart(this, true);
        ...
        visitor.visitAnnotationValueListNodeStop(this, true);
    ...
    {
        return operation.executeAnnotationValueListNode(this, p);
    }
    ...
    {
        return operation.executeAnnotationValueListNode(this, p1, p2);
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof AnnotationValueNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (AnnotationValueNode)after);
        }
        return false;
    }
     ...
     */
    protected AnnotationValueNode wrapElement(AnnotationValueNode element)
    {
        return getProxyFactory().makeAnnotationValueNode(element);
    }
