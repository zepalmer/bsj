...
import edu.jhu.cs.bsj.compiler.ast.node.StatementSpliceNode;
import edu.jhu.cs.bsj.compiler.ast.node.meta.MetaAnnotationListNode;
import edu.jhu.cs.bsj.compiler.impl.ast.BsjNodeManager;
import edu.jhu.cs.bsj.compiler.impl.ast.node.meta.SpliceNodeImpl;

@Generated(value={"edu.jhu.cs.bsj.compiler.utils.generator.SourceGenerator"})
public class StatementSpliceNodeImpl extends SpliceNodeImpl implements StatementSpliceNode
{
    /** General constructor. */
    public StatementSpliceNodeImpl(
    ...
    {
        return factory.makeStatementSpliceNode(
