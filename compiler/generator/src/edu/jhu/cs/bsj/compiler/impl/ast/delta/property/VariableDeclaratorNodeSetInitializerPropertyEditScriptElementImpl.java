...
public class VariableDeclaratorNodeSetInitializerPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public VariableDeclaratorNodeSetInitializerPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<VariableInitializerNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<VariableInitializerNode>((VariableInitializerNode)value);
        }
    ...
    {
        return VariableDeclaratorNodeProperties.INITIALIZER;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new VariableDeclaratorNodeSetInitializerPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
