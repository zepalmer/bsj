...
public class AnnotationElementListNodeImpl extends ListNodeImpl<AnnotationElementNode> implements AnnotationElementListNode
{
    /** General constructor. */
    public AnnotationElementListNodeImpl(
    ...
    /** Proxy constructor. */
    public AnnotationElementListNodeImpl(BsjNodeManager manager, BsjNodeProxyFactory proxyFactory, AnnotationElementListNode backingNode)
    {
        super(manager, proxyFactory, backingNode);
    }
    
    /** Retrieves this node's backing node (if one exists). */
    protected AnnotationElementListNode getBackingNode()
    {
        return (AnnotationElementListNode)super.getBackingNode();
    }
    ...
    protected Class<AnnotationElementNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitAnnotationElementListNodeStart(this, true);
        ...
        visitor.visitAnnotationElementListNodeStop(this, true);
    ...
    {
        return operation.executeAnnotationElementListNode(this, p);
    }
    ...
    {
        return operation.executeAnnotationElementListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends AnnotationElementNode>> childrenCopy = new ArrayList<NodeUnion<? extends AnnotationElementNode>>(getChildren().size());
        for (NodeUnion<? extends AnnotationElementNode> element : getUnionForChildren())
        {
            NodeUnion<? extends AnnotationElementNode> elementCopy;
        ...
        return factory.makeAnnotationElementListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof AnnotationElementNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (AnnotationElementNode)after);
        }
        return false;
    }
     ...
     */
    protected AnnotationElementNode wrapElement(AnnotationElementNode element)
    {
        return getProxyFactory().makeAnnotationElementNode(element);
    }
