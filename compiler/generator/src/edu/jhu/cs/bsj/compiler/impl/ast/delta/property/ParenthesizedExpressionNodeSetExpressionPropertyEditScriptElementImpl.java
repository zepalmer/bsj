...
public class ParenthesizedExpressionNodeSetExpressionPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ParenthesizedExpressionNodeSetExpressionPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        ParenthesizedExpressionNode target = (ParenthesizedExpressionNode)patchState.getNode(this.getTargetId());
    ...
    {
        return ParenthesizedExpressionNodeProperties.EXPRESSION;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ParenthesizedExpressionNodeSetExpressionPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
