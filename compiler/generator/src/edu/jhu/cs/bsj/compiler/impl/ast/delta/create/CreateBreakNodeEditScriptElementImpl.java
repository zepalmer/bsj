...
public class CreateBreakNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateBreakNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long label,
    ...
    public void apply(PatchState patchState)
    {
        ...
        BreakNode createdNode = patchState.getNodeFactory().makeBreakNodeWithUnions(label,
                metaAnnotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<BreakNode> getCreateType()
    {
    ...
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":BreakNode(" + "label=" + "#" + label + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateBreakNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
