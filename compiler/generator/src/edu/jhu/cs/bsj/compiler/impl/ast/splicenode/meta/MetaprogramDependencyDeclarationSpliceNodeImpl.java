...
public class MetaprogramDependencyDeclarationSpliceNodeImpl extends SpliceNodeImpl implements MetaprogramDependencyDeclarationSpliceNode
{
    /** General constructor. */
    public MetaprogramDependencyDeclarationSpliceNodeImpl(
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setTargets(MetaprogramDependencyListNode arg)
    {
    ...
    {
        return factory.makeMetaprogramDependencyDeclarationSpliceNode(
