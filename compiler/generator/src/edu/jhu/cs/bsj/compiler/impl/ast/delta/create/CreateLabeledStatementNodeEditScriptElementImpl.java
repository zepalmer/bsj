...
public class CreateLabeledStatementNodeEditScriptElementImpl extends AbstractCreateEditScriptElementImpl
{
    ...
    public CreateLabeledStatementNodeEditScriptElementImpl(
            int metaprogramId,
            long targetId,
            Long label,
            Long statement,
    ...
    public void apply(PatchState patchState)
    {
        ...
        LabeledStatementNode createdNode = patchState.getNodeFactory().makeLabeledStatementNodeWithUnions(label,
                statement,
                metaAnnotations,
                startLocation,
                stopLocation);
    ...
    @Override
    public Class<LabeledStatementNode> getCreateType()
    {
        return LabeledStatementNode.class;
    }
    
    @Override
    public String toString()
    {
        return "[" + getMetaprogramId() + "]+#" + getTargetId() + ":LabeledStatementNode(" + "label=" + "#" + label + "," + "statement=" + "#" + statement + "," + "metaAnnotations=" + "#" + metaAnnotations + "," + "startLocation=" + "{" + startLocation + "}" + "," + "stopLocation=" + "{" + stopLocation + "}" + ")";
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        translationState.getInstantiations().add(getTargetId());
        return new CreateLabeledStatementNodeEditScriptElementImpl(
                getMetaprogramId(),
                getTargetId(),
