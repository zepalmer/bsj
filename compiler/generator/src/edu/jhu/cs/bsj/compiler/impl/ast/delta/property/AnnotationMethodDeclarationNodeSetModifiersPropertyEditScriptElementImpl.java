...
public class AnnotationMethodDeclarationNodeSetModifiersPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public AnnotationMethodDeclarationNodeSetModifiersPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        {
            union = new SpliceNodeUnion<AnnotationMethodModifiersNode>((SpliceNode)value);
        } else 
        {
            union = new NormalNodeUnion<AnnotationMethodModifiersNode>((AnnotationMethodModifiersNode)value);
        }
    ...
    {
        return AnnotationMethodDeclarationNodeProperties.MODIFIERS;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new AnnotationMethodDeclarationNodeSetModifiersPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
