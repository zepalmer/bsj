...
public class ForLoopNodeSetStatementPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public ForLoopNodeSetStatementPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return ForLoopNodeProperties.STATEMENT;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new ForLoopNodeSetStatementPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
