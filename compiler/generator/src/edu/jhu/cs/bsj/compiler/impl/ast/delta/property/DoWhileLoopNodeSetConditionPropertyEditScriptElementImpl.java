...
public class DoWhileLoopNodeSetConditionPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public DoWhileLoopNodeSetConditionPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    {
        return DoWhileLoopNodeProperties.CONDITION;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new DoWhileLoopNodeSetConditionPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
