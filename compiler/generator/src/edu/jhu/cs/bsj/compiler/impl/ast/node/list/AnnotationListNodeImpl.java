...
public class AnnotationListNodeImpl extends ListNodeImpl<AnnotationNode> implements AnnotationListNode
{
    ...
    protected Class<AnnotationNode> getChildrenElementType()
    {
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitAnnotationListNodeStart(this, true);
        ...
        visitor.visitAnnotationListNodeStop(this, true);
    ...
    {
        return operation.executeAnnotationListNode(this, p);
    }
    ...
    {
        return operation.executeAnnotationListNode(this, p1, p2);
    }
    ...
    {
        List<NodeUnion<? extends AnnotationNode>> childrenCopy = new ArrayList<NodeUnion<? extends AnnotationNode>>(getChildren().size());
        for (NodeUnion<? extends AnnotationNode> element : getUnionForChildren())
        {
            NodeUnion<? extends AnnotationNode> elementCopy;
        ...
        return factory.makeAnnotationListNodeWithUnions(
                childrenCopy,
                getStartLocation(),
                getStopLocation());
    }
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof AnnotationNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (AnnotationNode)after);
        }
        return false;
    }
