...
public class SingleStaticImportNodeSetIdentifierPropertyEditScriptElementImpl extends AbstractNodePropertyEditScriptElementImpl
{
    public SingleStaticImportNodeSetIdentifierPropertyEditScriptElementImpl(int metaprogramId, long targetId, Long valueId)
    {
    ...
    public void apply(PatchState patchState)
    {
        ...
        SingleStaticImportNode target = (SingleStaticImportNode)patchState.getNode(this.getTargetId());
    ...
    {
        return SingleStaticImportNodeProperties.IDENTIFIER;
    }
    
    public EditScriptElement translate(TranslationState translationState) throws IllegalArgumentException
    {
        return new SingleStaticImportNodeSetIdentifierPropertyEditScriptElementImpl(getMetaprogramId(), translateUid(translationState, getTargetId()),
