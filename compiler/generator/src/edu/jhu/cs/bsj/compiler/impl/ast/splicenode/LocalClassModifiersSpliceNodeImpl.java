...
import edu.jhu.cs.bsj.compiler.ast.node.LocalClassModifiersSpliceNode;
...
public class LocalClassModifiersSpliceNodeImpl extends SpliceNodeImpl implements LocalClassModifiersSpliceNode
{
    /** General constructor. */
    public LocalClassModifiersSpliceNodeImpl(
    ...
    {
        throw new SpliceNodeAccessException("Attempted to get property \"strictfpFlag\" from a splice node.");
    }
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setStrictfpFlag(boolean arg)
    {
        throw new SpliceNodeAccessException("Attempted to set property \"strictfpFlag\" from a splice node.");
    }
    ...
    {
        throw new SpliceNodeAccessException("Attempted to get property \"abstractFlag\" from a splice node.");
    }
     ...
     * @throws SpliceNodeAccessException Always.
     */
    public void setAbstractFlag(boolean arg)
    {
        throw new SpliceNodeAccessException("Attempted to set property \"abstractFlag\" from a splice node.");
    }
     ...
     */
    @Override
    public LocalClassModifiersSpliceNode deepCopy(BsjNodeFactory factory)
    {
        return factory.makeLocalClassModifiersSpliceNode(
