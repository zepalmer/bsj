...
public class PackageListNodeImpl extends ListNodeImpl<PackageNode> implements PackageListNode
{
    ...
    public void receiveTyped(BsjTypedNodeVisitor visitor)
    {
        ...
        visitor.visitPackageListNodeStart(this, true);
        ...
        visitor.visitPackageListNodeStop(this, true);
    ...
    {
        return operation.executePackageListNode(this, p);
    }
    ...
    {
        return factory.makePackageListNode(
                new ArrayList<PackageNode>(getChildren()),
    ...
    public boolean replace(Node before, Node after)
    {
        ...
        if (after instanceof PackageNode)
        {
            int index = getChildren().indexOf(before);
            if (index != -1)
                getChildren().set(index, (PackageNode)after);
        }
        return false;
    }
